...
@Component({
  selector: 'app-boardrep',
  templateUrl: './boardrep.component.html',
  styleUrls: ['./boardrep.component.css']
})
export class BoardrepComponent implements OnInit {

  @Input() gameIdInput: number;
